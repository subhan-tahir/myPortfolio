          ...
          {/* {loading
            ? [...Array(3)].map((_, index) => (
             ...
             myWork.slice(0, showProjects).map((project, index) => 
                  ...
                  <div
                    key={index}
                    className="group relative sm:w-[350px] hover:scale-[1.05] sm:h-[350px] h-auto rounded-xl border border-white/10 bg-black px-8 py-14 shadow-xl transition-all ease-in-out duration-500 hover:!shadow-xl hover:!shadow-black"
                  >
                    <div className="flex flex-col gap-4 p-2">
                      ...
                      >
                        <button className="bg-white relative sm:h-12 h-8 w-full overflow-hidden border text-black font-bold  transition-all duration-500 before:absolute before:bottom-0 before:left-0 before:right-0 before:top-0 before:m-auto before:h-0 before:w-0 before:rounded-sm before:bg-black before:duration-500 before:ease-out before:text-white hover:!text-white shadow-sm hover:shadow-white hover:before:h-40 hover:before:w-40 hover:before:opacity-80 hover:!bg-black">
